...
struct AnalysisView: View {
    ...
    @State var totalOverConsume: Int = 355540
    @State var totalConsume: Int = 723650
    @State var isAlbed: Bool = false
                    ...
                    VStack(alignment: .leading) {
                        ...
                        VStack(alignment: .leading, spacing: 12.0) {
                            ...
                            VStack(alignment: .leading, spacing: 4.0) {
                                Text("과소비를 4번 하지 않았다면")
                                    .modifier(H2SemiBold())
                                Text("355,540원을 아꼈을텐데")
                                    .modifier(H2SemiBold())
                        ...
                        VStack(spacing: 8) {
                            ...
                            VStack(spacing: 10.0) {
                                TopContentView(rank: 1, content: "에이블리/결제 신이 오셨다!", money: 203540)
                                TopContentView(rank: 2, content: "MC3 회식", money: 34000)
                                TopContentView(rank: 3, content: "통집 | 간맥", money: 19331)
                            }
                            .padding(.bottom, 28.0)
